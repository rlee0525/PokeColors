	  ...
	  _createClass(Pokemon, [{
	    ...
	    value: function createBars() {
	      ...
	      for (var i = 1; i < 10; i++) {
	        ...
	        ctx.lineWidth = 3;
	        ctx.strokeStyle = 'black';
	        ctx.strokeText("" + colorsPercentage[i].color, "" + (barWidth + 10), "" + ((this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1) + this.canvas.height / 16));
	        ctx.fillText("" + colorsPercentage[i].color, "" + (barWidth + 10), "" + ((this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1) + this.canvas.height / 16));
	      }
