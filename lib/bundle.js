	  ...
	  _createClass(Pokemon, [{
	    ...
	    value: function createBars() {
	      ...
	      for (var i = 1; i < 10; i++) {
	        ...
	        ctx.rect(0, "" + (this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1), "" + colorsPercentage[i].percentage * 3000, this.canvas.height / 9.4);
	        ctx.stroke();
	
	        ctx.fillStyle = "" + colorsPercentage[i].color;
	        ctx.lineWidth = "5";
	        ctx.strokeStyle = "blue";
	        ctx.fillRect(0, "" + (this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1), "" + colorsPercentage[i].percentage * 3000, this.canvas.height / 9.4);
	
	        ctx.font = "23px pokemon";
	        ctx.lineWidth = 3;
	        ctx.strokeStyle = 'black';
	        ctx.strokeText("" + colorsPercentage[i].color, "" + (colorsPercentage[i].percentage * 3000 + 10), "" + ((this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1) + this.canvas.height / 16));
	        ctx.fillText("" + colorsPercentage[i].color, "" + (colorsPercentage[i].percentage * 3000 + 10), "" + ((this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1) + this.canvas.height / 16));
	      }
	      ...
	      ctx.lineWidth = 5;
	      ctx.strokeStyle = 'black';
	      ctx.strokeText("" + pokemonName, canvas.width - 350, 50);
	      ctx.fillStyle = "" + primaryColor;
	      ctx.fillText("" + pokemonName, canvas.width - 350, 50);
	
	      ctx.font = "23px pokemon";
	      ctx.lineWidth = 5;
	      ctx.strokeStyle = 'black';
	      ctx.strokeText("" + primaryColor, canvas.width - 280, 100);
	      ctx.fillStyle = "" + primaryColor;
	      ctx.fillText("" + primaryColor, canvas.width - 280, 100);
	    }
	  }, {
	    key: "generatePokemon",
