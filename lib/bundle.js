	  ...
	  _createClass(Pokemon, [{
	    ...
	    value: function createBars() {
	      ...
	      for (var i = 1; i < 10; i++) {
	        ...
	        ctx.rect(0, "" + (this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1), "" + colorsPercentage[i].percentage * 2800, this.canvas.height / 9.4);
	        ctx.stroke();
	
	        ctx.fillStyle = "" + colorsPercentage[i].color;
	        ctx.lineWidth = "5";
	        ctx.strokeStyle = "blue";
	        ctx.fillRect(0, "" + (this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1), "" + colorsPercentage[i].percentage * 2800, this.canvas.height / 9.4);
	
	        ctx.font = "23px pokemon";
	        ctx.lineWidth = 3;
	        ctx.strokeStyle = 'black';
	        ctx.strokeText("" + colorsPercentage[i].color, "" + (colorsPercentage[i].percentage * 2800 + 10), "" + ((this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1) + this.canvas.height / 16));
	        ctx.fillText("" + colorsPercentage[i].color, "" + (colorsPercentage[i].percentage * 2800 + 10), "" + ((this.canvas.height / 9.4 + this.canvas.height / 300) * (i - 1) + this.canvas.height / 16));
	      }
	    ...
	    value: function searchPokemon() {
	      var pokeNum = $('#search-box-input').val();
